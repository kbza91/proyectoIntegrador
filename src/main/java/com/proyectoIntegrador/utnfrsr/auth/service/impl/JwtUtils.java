...
public class JwtUtils {
    ...
    private static final String SECRET_KEY = "mi_clave_super_segura_y_muy_larga_123456789";

    private Key getSigningKey() {
        // ⚠️ No uses Decoders.BASE64.decode() si tu clave no está en base64
        // Convertimos directamente a bytes UTF-8:
